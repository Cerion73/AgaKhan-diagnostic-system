# Generated by Django 5.1.6 on 2025-04-25 10:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serial_no', models.CharField(default='ABC123', max_length=200, unique=True)),
                ('gender', models.CharField(choices=[('F', 'Female'), ('M', 'Male'), ('I', 'Intersex'), ('O', 'Other')], default='female', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 4, 25, 10, 58, 49, 720138, tzinfo=datetime.timezone.utc))),
